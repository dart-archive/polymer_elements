...
/// Dart API for the polymer element `paper_menu_button_animations`.
@HtmlImport('paper_menu_button_animations_nodart.html')
library polymer_elements.lib.src.paper_menu_button.paper_menu_button_animations;
