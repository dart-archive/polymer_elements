...
/// Dart API for the polymer element `carbon_route`.
@HtmlImport('carbon_route_nodart.html')
library polymer_elements.lib.src.carbon_route.carbon_route;
...
@CustomElementProxy('carbon-route')
class CarbonRoute extends HtmlElement with CustomElementProxyMixin, PolymerBase {
  CarbonRoute.created() : super.created();
  factory CarbonRoute() => new Element.tag('carbon-route');
