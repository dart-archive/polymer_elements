...
/// Dart API for the polymer element `platinum_sw_fetch`.
@HtmlImport('platinum_sw_fetch_nodart.html')
library polymer_elements.lib.src.platinum_sw.platinum_sw_fetch;
...
@CustomElementProxy('platinum-sw-fetch')
class PlatinumSwFetch extends HtmlElement with CustomElementProxyMixin, PolymerProxyMixin {
  PlatinumSwFetch.created() : super.created();
  factory PlatinumSwFetch() => new Element.tag('platinum-sw-fetch');
  ...
  /// *
  String get handler => jsElement[r'handler'];
  set handler(String value) { jsElement[r'handler'] = value; }
  ...
  String get origin => jsElement[r'origin'];
  set origin(String value) { jsElement[r'origin'] = value; }
